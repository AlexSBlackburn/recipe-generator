    ...
    <App>
        ...
        >
            <div class="max-w-12xl mx-auto p-6 lg:p-8">
                ...
                <div class="w-64 mt-16 text-center">
                    <IngredientForm @ingredients="setIngredients" />
                    <v-divider class="my-6 border-black" />
                    <v-btn @click="getRecipe">Generate recipe</v-btn>
                </div>
